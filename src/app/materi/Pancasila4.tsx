...
export const Pancasila4Metadata = {
  title: "Pendidikan Pancasila",
  subtitle: "Pembelajaran nilai-nilai Pancasila",
  className: "4 Sekolah Dasar",
  curriculum: "Kurikulum Merdeka",
  overlayTitle: "Materi Pendidikan Pancasila Kelas 4",
  overlayContent: [
    {
...
interface Pancasila4Props {
  selectedTopicTitle: string;
}

export default function Pancasila4({ selectedTopicTitle }: Pancasila4Props) {
  const materiData = {
    bab: [
      {
        title: "Mengenal Diri dan Teman",
