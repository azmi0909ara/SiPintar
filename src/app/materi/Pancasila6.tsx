...
export const Pancasila6Metadata = {
  title: "Pendidikan Pancasila",
  subtitle: "Pembelajaran nilai-nilai Pancasila",
  className: "6 Sekolah Dasar",
  curriculum: "Kurikulum Merdeka",
  overlayTitle: "Materi Pendidikan Pancasila Kelas 6",
  overlayContent: [
    {
...
interface Pancasila6Props {
  selectedTopicTitle: string;
}

export default function Pancasila6({ selectedTopicTitle }: Pancasila6Props) {
  const materiData = {
    bab: [
      {
        title: "Mengenal Diri dan Teman",
