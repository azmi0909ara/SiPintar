...
export const Indonesia2Metadata = {
  title: "Bahasa Indonesia: Keluargaku Unik",
  subtitle: "Bahasa Indonesia",
  className: "2 Sekolah Dasar",
  curriculum: "Kurikulum Merdeka",
  overlayTitle: "Materi Bahasa Indonesia Kelas 2",
  overlayContent: [
    {
...
interface Indonesia2Props {
  selectedTopicTitle: string;
}

export default function Indonesia2({ selectedTopicTitle }: Indonesia2Props) {
  const materiData = {
    bab: [
      {
        title: "Mengenal Perasaan",
          ...
          },
          {
            ...
            content: [
              "Perasaan bisa terlihat dari wajah dan sikap tubuh:",
              {
                ...
                examples: [
                  { text: "Senang: tersenyum dan mata berbinar", image: "images/senang.jpeg" },
                  { text: "Sedih: wajah murung dan kadang menangis", image: "images/sedih.png" },
                  { text: "Marah: cemberut dan suara keras", image: "images/marah.jpeg" },
                  { text: "Takut: wajah tegang dan gelisah", image: "images/takut.jpeg" },
                  { text: "Malu: menunduk dan diam", image: "images/malu.jpeg" }
                ],
              },
          ...
          },
          {
            ...
            content: [
              "Kita perlu mengenali tanda-tanda peringatan:",
              {
                text: "Contoh tanda:",
                examples: [
                  { text: "🚫 Dilarang merokok", image: "images/dilarang-merokok.png" },
                  {text: "⚠️ Hati-hati lantai licin", image: "images/lantai-licin.png" },
                ],
              },
