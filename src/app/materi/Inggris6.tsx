...
interface Inggris6Props {
  selectedTopicTitle: string;
}

export default function Inggris6({ selectedTopicTitle }: Inggris6Props) {
  const materiData = {
    bab: [
      {
        title: "Greetings and Introductions",
        ...
        subtopics: [
          ...
          },
          {
            ...
            content: [
              ...
              {
                examples: ["Red", "Blue", "Yellow", "Green", "Black", "White", "Brown", "Orange", "Purple", "Gray"]
              },
              {
                text: "Examples:",
                examples: [
        ...
        subtopics: [
          {
            ...
            content: [
              ...
              {
                examples: ["Circle", "Square", "Triangle", "Rectangle", "Star", "Heart"]
              },
              {
                text: "Examples:",
                examples: [
        ...
        subtopics: [
          {
            ...
            content: [
              ...
              {
                examples: ["Apple", "Banana", "Orange", "Mango", "Watermelon", "Grapes", "Strawberry"]
              },
              {
          ...
          },
          {
            ...
            content: [
              ...
              {
                examples: ["Cat", "Dog", "Bird", "Fish", "Cow", "Goat", "Chicken", "Duck"]
              },
              {
                text: "Examples:",
                examples: [
