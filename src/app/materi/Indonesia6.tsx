...
export const Indonesia6Metadata = {
  title: "Bahasa Indonesia: Keluargaku Unik",
  subtitle: "Bahasa Indonesia",
  className: "6 Sekolah Dasar",
  curriculum: "Kurikulum Merdeka",
  overlayTitle: "Materi Bahasa Indonesia Kelas 6",
  overlayContent: [
    {
...
interface Indonesia6Props {
  selectedTopicTitle: string;
}

export default function Indonesia6({ selectedTopicTitle }: Indonesia6Props) {
  const materiData = {
    bab: [
      {
        title: "Mengenal Perasaan",
