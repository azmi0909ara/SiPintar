...
export const Indonesia4Metadata = {
  title: "Bahasa Indonesia: Keluargaku Unik",
  subtitle: "Bahasa Indonesia",
  className: "4 Sekolah Dasar",
  curriculum: "Kurikulum Merdeka",
  overlayTitle: "Materi Bahasa Indonesia Kelas 4",
  overlayContent: [
    {
...
interface Indonesia4Props {
  selectedTopicTitle: string;
}

export default function Indonesia4({ selectedTopicTitle }: Indonesia4Props) {
  const materiData = {
    bab: [
      {
        title: "Mengenal Perasaan",
