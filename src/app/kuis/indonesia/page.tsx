...
import { indonesiaQuestions } from "@/data/indonesia";
import { useRouter } from "next/navigation";

export default function QuizIndonesia() {
  ...
  const startQuiz = () => {
    const shuffled = [...indonesiaQuestions]
        ...
        {!showResult ? (
          <>
            <div>
              ...
              <p className="text-black text-gray-800 text-lg mb-6 leading-relaxed">
